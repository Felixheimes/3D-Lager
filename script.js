// Check if THREE is defined before running the script
if (typeof THREE === 'undefined') {
    console.error("THREE.js is not defined! Make sure it is loaded in index.html.");
} else {
    console.log("THREE.js is ready! Initializing 3D scene...");
